---
doc_id: ros2-doc-cli
title: "ROS 2 docs · Command line tools"
dept: engineering
...
expires: null
license: CC-BY-4.0
upstream: https://github.com/ros2/ros2_documentation/blob/humble/source/Concepts/Basic/About-Command-Line-Tools.rst
---

> 摘自 ROS 2 Documentation（Humble），[CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)。原文：<https://github.com/ros2/ros2_documentation/blob/humble/source/Concepts/Basic/About-Command-Line-Tools.rst>
...
The daemon communicates using the localhost network interface (127.0.0.1) and uses the ROS_DOMAIN_ID <../Intermediate/About-Domain-ID> environment variable as a port number offset.
This means that if you want to control a specific daemon instance (for example, using `ros2 daemon stop`), you must ensure that your ROS_DOMAIN_ID <../Intermediate/About-Domain-ID> matches the domain ID used by that daemon.
Different ROS_DOMAIN_ID <../Intermediate/About-Domain-ID> values will result in separate daemon instances running on different ports.
