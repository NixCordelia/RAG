---
doc_id: ros2-doc-composition
title: "ROS 2 docs · Composition"
dept: engineering
...
expires: null
license: CC-BY-4.0
upstream: https://github.com/ros2/ros2_documentation/blob/humble/source/Concepts/Intermediate/About-Composition.rst
---

> 摘自 ROS 2 Documentation（Humble），[CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)。原文：<https://github.com/ros2/ros2_documentation/blob/humble/source/Concepts/Intermediate/About-Composition.rst>
>
> 下列「中文要点」为入库时补充，便于中文检索；事实仍来自原文。

# 中文要点

组件编译成共享库，由容器进程加载，不是带 main 的独立可执行文件。
...
* running multiple nodes in a single process with the lower overhead and optionally more efficient communication (see Intra Process Communication <../../Tutorials/Demos/Intra-Process-Communication>).
...
For more information about the types of executors, see the TypesOfExecutors.
For more information about the options of each component container, see ComponentContainerTypes in the composition tutorial.
...
For an example, check out this tutorial <../../Tutorials/Intermediate/Writing-a-Composable-Node>
...
Try the Composition demos <../../Tutorials/Intermediate/Composition>.
