---
doc_id: ros2-doc-topic-stats
title: "ROS 2 docs · Topic statistics"
dept: engineering
...
expires: null
license: CC-BY-4.0
upstream: https://github.com/ros2/ros2_documentation/blob/humble/source/Concepts/Intermediate/About-Topic-Statistics.rst
---

> 摘自 ROS 2 Documentation（Humble），[CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)。原文：<https://github.com/ros2/ros2_documentation/blob/humble/source/Concepts/Intermediate/About-Topic-Statistics.rst>
>
> 下列「中文要点」为入库时补充，便于中文检索；事实仍来自原文。

# 中文要点

打开 Topic Statistics 后，统计默认发到 `/statistics` 话题，周期默认 1 秒。
