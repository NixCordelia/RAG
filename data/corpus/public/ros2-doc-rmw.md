---
doc_id: ros2-doc-rmw
title: "ROS 2 docs · Middleware vendors"
dept: engineering
...
expires: null
license: CC-BY-4.0
upstream: https://github.com/ros2/ros2_documentation/blob/humble/source/Concepts/Intermediate/About-Different-Middleware-Vendors.rst
---

> 摘自 ROS 2 Documentation（Humble），[CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)。原文：<https://github.com/ros2/ros2_documentation/blob/humble/source/Concepts/Intermediate/About-Different-Middleware-Vendors.rst>
...
Other RMWs like Cyclone DDS, Connext or GurumDDS can be enabled by installing additional packages <../../Installation/RMW-Implementations>, but without having to rebuild anything or replace any existing packages.
